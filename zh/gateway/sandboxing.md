...
-   三个图形硬化标志 (`--disable-3d-apis`, `--disable-software-rasterizer`, `--disable-gpu`) 是可选的，在容器缺乏 GPU 支持时很有用。如果您的工作负载需要 WebGL 或其他 3D/浏览器功能，请设置 `OPENCLAW_BROWSER_DISABLE_GRAPHICS_FLAGS=0`。
